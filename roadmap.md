...
- [x] B3/B4 — Identificar presupuesto y aclarar que Generales ya está prorrateado
- [x] B5 — Mostrar trazabilidad T/C sólo para monedas no-MXN presentes
- [x] Cierre: pruebas focalizadas, versión, changelog y manifiesto; sin publicar
...
- [x] 3 P1 — Centralizar conversión y redondeo a 2 decimales (dashboard vs detalle)
...
- [x] 9 P2 — Pulido HD: tabs con flechas sin scrollbar (hecho), tabla de costos (hecho), encabezado Cotizaciones, FAB, contadores y español
- [x] Cierre: pruebas de regresión, versión, changelog y manifiesto; sin publicar
