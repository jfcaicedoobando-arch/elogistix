 ...
 * v13.68.9: extraídos sub-componentes locales para reducir complejidad ciclomática.
 */
...
function CardHeader({ row, rank, esGanador }: { row: TopTarifaRow; rank: number; esGanador: boolean }) {
  return (
...
function FechaVigencia({ vigenteHasta, vencePronto }: { vigenteHasta: string; vencePronto: boolean }) {
  return (
