 ...
 */
export { parseConfigSafe, plataformaConfigSchema, seguridadConfigSchema, useConfiguracionByOrg, useConfiguracionState, useConfigGlobalCategoria, useUpdateConfiguracionGlobal, useIvaFronteraHabilitada } from "./hooks";
