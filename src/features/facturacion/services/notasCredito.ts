...
// La transición de estado vive en `notasCreditoEstado.ts` (límite de 200
// líneas por archivo); se re-exporta para no romper importadores.
export { cambiarEstadoNotaCredito } from "./notasCreditoEstado";
