    ...
    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
      <div className="space-y-2 md:col-span-2">
        ...
        <Input
          ...
          aria-invalid={errors.descripcionMercancia ? true : undefined}
          className={cn(errors.descripcionMercancia && 'border-destructive')}
      ...
      <div className="space-y-2">
        ...
        <Controller name="tipoCarga" render={({ field }) => (
          <Select value={field.value} onValueChange={field.onChange}>
            <SelectTrigger
              id="emb-tipo-carga"
              aria-invalid={errors.tipoCarga ? true : undefined}
              className={cn(errors.tipoCarga && 'border-destructive')}
            >
        ...
        {errors.tipoCarga && <p className="text-xs text-destructive">{errors.tipoCarga}</p>}
      </div>
      ...
      <div className="space-y-2">
        ...
        <Input
          ...
          type="number"
          placeholder="0"
          aria-invalid={errors.pesoKg ? true : undefined}
          className={cn(errors.pesoKg && 'border-destructive')}
          {...register('pesoKg')}
        />
        {errors.pesoKg && <p className="text-xs text-destructive">{errors.pesoKg}</p>}
      </div>
      <div className="space-y-2">
        ...
        <Input
          ...
          type="number"
          placeholder="0"
          aria-invalid={errors.volumenM3 ? true : undefined}
          className={cn(errors.volumenM3 && 'border-destructive')}
          {...register('volumenM3')}
        />
        {errors.volumenM3 && <p className="text-xs text-destructive">{errors.volumenM3}</p>}
      </div>
      <div className="space-y-2">
        ...
        <Input
          ...
          type="number"
          placeholder="0"
          aria-invalid={errors.piezas ? true : undefined}
          className={cn(errors.piezas && 'border-destructive')}
          {...register('piezas')}
        />
        {errors.piezas && <p className="text-xs text-destructive">{errors.piezas}</p>}
      </div>
    </div>
  );
}
