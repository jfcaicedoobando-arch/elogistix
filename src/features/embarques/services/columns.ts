...
// FIX2 · B-1: `tarifa_delta_jsonb` salió de esta lista (privilegio de columna
// revocado a `authenticated`); se lee por `embarques_interno_v`.
export const EMBARQUE_DETAIL_COLUMNS =
  'id, expediente, bl_master, bl_house, mawb, hawb, carta_porte, cliente_id, cliente_nombre, consignatario, shipper, modo, tipo, estado, etd, eta, fecha_creacion, fecha_llegada_real, operador, agente, agente_id, naviera, naviera_id, aerolinea, transportista, contenedor, tipo_contenedor, tipo_servicio, tipo_carga, descripcion_mercancia, peso_kg, volumen_m3, piezas, incoterm, puerto_origen, puerto_destino, aeropuerto_origen, aeropuerto_destino, ciudad_origen, ciudad_destino, msds_archivo, organization_id, cotizacion_id, tipo_cambio_usd, tipo_cambio_eur, tiene_proforma, tarifa_id_original, tarifa_id_aplicada, tarifa_decision, tarifa_revalidada_en, tarifa_revalidada_por, cobro_cliente_status, cobro_cliente_actualizado_at, puerto_origen_id, puerto_destino_id, created_at, updated_at' as const;
