...
const COLS =
  "id, nombre, cliente_id, cliente_nombre, lead_id, vendedor_id, vendedor_email, etapa_id, monto_estimado, valor_real, moneda, probabilidad, fecha_estimada_cierre, fecha_cierre_real, motivo_perdida_id, modo, tipo_carga, origen, destino, puerto_origen_id, puerto_destino_id, notas, monto_meta, fecha_meta_cierre, compromiso_nota, margen_pct, margen_autorizado_por, margen_autorizado_at, riesgos_objeciones, cotizacion_ganadora_id, embarque_ganador_id, created_at, updated_at";
