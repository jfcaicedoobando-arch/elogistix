...
export const CRM_ACTIVIDADES_COLUMNS_FULL =
  "id, tipo, asunto, descripcion, entidad_tipo, entidad_id, fecha_programada, fecha_completada, duracion_min, resultado, responsable_id, responsable_email, contacto_efectivo, reunion_calificada, created_at, updated_at" as const;
