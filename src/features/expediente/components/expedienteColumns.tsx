/**
 * Ola 4 — Columnas compartidas del expediente documental (cliente y proveedor).
...
interface Acciones<T> {
  onDescargar: (doc: T) => void;
  onEliminar?: (doc: T) => void;
}

export function expedienteColumns<T extends DocumentoExpediente>(
  acciones: Acciones<T>,
): ColumnDef<T, unknown>[] {
  return [
    {
