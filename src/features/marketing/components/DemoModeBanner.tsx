...
export function DemoModeBanner() {
  ...
  return (
    <div
      role="status"
      className="sticky top-0 z-toast flex items-center justify-center gap-2 bg-accent px-4 py-2 text-center text-xs font-medium text-accent-foreground shadow-card sm:text-sm"
    >
