...
function reporte(hallazgos: HallazgoAuditoria[]): ReporteAuditoria {
  return {
    ...
    por_regla: {
      ...
      embarque_huerfano: 0, factura_sin_timbrar: 0, rep_pendiente: 0, factura_cancelada_sin_sustitucion: 0, cxc_vencida: 0, cxp_por_capturar_estancada: 0, cxp_vencida: 0, contenedor_datos_incompletos: 0, contenedor_fechas_incompletas: 0, tipo_cambio_faltante: 0,
    },
    hallazgos,
  };
}
