/**
 * Queries/mutations contra `public.notificaciones_internas` y su canal realtime.
 * Los hooks consumen este servicio en lugar de importar `supabase` directamente.
 */
