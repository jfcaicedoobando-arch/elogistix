  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-body">
      <label className="space-y-1">
        <span className="text-body-sm text-muted-foreground">Tiempo de tránsito (días)</span>
        <Input
          type="number" min={0}
          value={transito ?? ""}
        ...
        />
        {Boolean(override.tiempoTransitoDias) && <span className="text-body-sm text-warning">Sobreescrito manualmente</span>}
      </label>
      <label className="space-y-1">
        <span className="text-body-sm text-muted-foreground">Frecuencia</span>
        ...
        {Boolean(override.frecuencia) && <span className="text-body-sm text-warning">Sobreescrito manualmente</span>}
      </label>
      {esFCL && (
        <label className="space-y-1">
          <span className="text-body-sm text-muted-foreground">Días libres en destino (demoras)</span>
          <Input
            type="number" min={0}
            value={diasLibres ?? ""}
          ...
          />
          {Boolean(override.diasLibresDestino) && <span className="text-body-sm text-warning">Sobreescrito manualmente</span>}
        </label>
      )}
      {esLCL && (
        <label className="space-y-1">
          <span className="text-body-sm text-muted-foreground">Días libres de almacenaje</span>
          <Input
            type="number" min={0}
          ...
          />
          {Boolean(override.diasAlmacenaje) && <span className="text-body-sm text-warning">Sobreescrito manualmente</span>}
        </label>
      )}
      {esFCL && (
        <label className="space-y-1">
          <span className="text-body-sm text-muted-foreground">Carta garantía</span>
          ...
          {Boolean(override.cartaGarantia) && <span className="text-body-sm text-warning">Sobreescrito manualmente</span>}
        </label>
      )}
    </div>
  );
