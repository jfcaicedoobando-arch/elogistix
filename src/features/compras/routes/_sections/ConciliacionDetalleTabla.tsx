/**
 * Cuerpo de tabla del ConciliacionDetalleSheet: filas y footer de totales por moneda.
 * Extraído de ConciliacionDetalleSections para respetar el techo Power of 10 (<200 líneas).
 */
