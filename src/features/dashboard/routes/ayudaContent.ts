 ...
 * Separado del componente para que sea fácil de mantener y traducir.
 * v13.118.1 — Refresh completo: glosario expandido y 12 módulos de FAQ
 * alineados a los roles modernos del ERP.
 */
...
export const MODULOS: AyudaModulo[] = [
  ...
  },
  {
    ...
    faqs: [
      ...
      { pregunta: "¿Cómo avanzo el estado del embarque?", respuesta: "Detalle → pestaña Tracking → 'Avanzar estado'. Los 7 estados son: Cotización, Confirmado, En tránsito, En puerto, Liberado, Entregado, Cerrado. Cada cambio genera evento de timeline automático." },
