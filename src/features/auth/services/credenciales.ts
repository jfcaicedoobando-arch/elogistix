/**
 * Operaciones de credenciales: alta, inicio de sesión, recuperación y cambio
 * de contraseña.
 *
 * Ola 20 · paso 4: extraído del `index.ts` del feature para que el índice sea
 * sólo superficie pública.
 */
