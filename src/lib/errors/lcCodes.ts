/**
 * Mapa central de códigos `LC_*` (RAISE EXCEPTION 'LC_XXX ...') a mensajes
 * amigables en es-MX. La lista se deriva de las migraciones de Supabase; si
 * un código no está aquí, el usuario ve el mensaje crudo del backend (fallback
 * seguro). Añade nuevas entradas conforme aparezcan nuevos códigos.
 *
