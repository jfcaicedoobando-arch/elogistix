 ...
 *
 * Promovido desde `features/auditoria/utils/diffFields.ts` (paso 9 de la
 * auditoría): lo consumen auditoría, clientes, proveedores y embarques.
 * Módulo puro: sin React, Supabase ni imports de features.
 *
