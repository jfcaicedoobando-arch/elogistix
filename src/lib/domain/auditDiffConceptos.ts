 ...
 *
 * Promovido desde `features/auditoria/utils/diffConceptos.ts` (paso 9 de la
 * auditoría): lo consumen auditoría y embarques. Módulo puro: sin React,
 * Supabase ni imports de features.
 */
