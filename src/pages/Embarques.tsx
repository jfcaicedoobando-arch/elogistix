  ...
  const filtered = useMemo(() => {
    return embarques.filter((embarque) => {
      const matchSearch = !search || embarque.expediente.toLowerCase().includes(search.toLowerCase()) ||
        ...
        ((embarque as any).referencia_operacion || '').toLowerCase().includes(search.toLowerCase());
          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead>Ref. Operación</TableHead>
              ...
              {paginated.length === 0 ? (
                ...
                return (
                  <TableRow key={embarque.id} className="cursor-pointer" onClick={() => navigate(`/embarques/${embarque.id}`)}>
                    ...
                    <TableCell className="text-xs text-muted-foreground">{(embarque as any).referencia_operacion || '-'}</TableCell>
