...
export default function Usuarios() {
  ...
  const confirmRoleChange = async () => {
    ...
    try {
      ...
      notifyError(toast, { title: "Error al cambiar rol", description: getErrorMessage(err), error: err, method: "CATCH" });
    } finally {
      setPendingRole(null);
    }
  };
  ...
  const handleDelete = async () => {
    ...
    try {
      ...
      notifyError(toast, { title: "Error al eliminar usuario", description: getErrorMessage(err), error: err, method: "CATCH" });
    }
  };
