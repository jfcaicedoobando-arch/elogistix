...
export const PORTAL_EVENTO_COLUMNS =
  'id, embarque_id, tipo, descripcion, ubicacion, fecha, usuario, organization_id, created_at, deleted_at, deleted_by' as const;

export const PORTAL_DOCUMENTO_COLUMNS =
  'id, embarque_id, nombre, archivo, estado, notas, organization_id, created_at, deleted_at, deleted_by' as const;
