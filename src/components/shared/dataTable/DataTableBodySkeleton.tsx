            ...
            return (
              <TableCell
                ...
                className={cn(
                  ...
                  meta.sticky && "sticky left-0 z-sticky bg-background [tr:nth-child(even)_&]:bg-muted/45 dark:[tr:nth-child(even)_&]:bg-muted/30 shadow-[4px_0_4px_-2px_hsl(var(--border)/0.3)]",
                  meta.stickyRight && "sticky right-0 z-sticky bg-background [tr:nth-child(even)_&]:bg-muted/45 dark:[tr:nth-child(even)_&]:bg-muted/30 shadow-[-4px_0_4px_-2px_hsl(var(--border)/0.3)]",
                )}
              >
