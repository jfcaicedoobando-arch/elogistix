...
import { fetchCliente360, type Cliente360Resumen } from "@/services/crm/cliente360";

export type { Cliente360Oportunidad, Cliente360Resumen } from "@/services/crm/cliente360";
