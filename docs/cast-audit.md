# Cast Audit — generado 2026-09-09
...
Total de `as` casts detectados: **3640**
...
| 8 | `src/features/configuracion/index.ts` | 10 | 20 | 0 | 0 | 10 | 0 | 0 |
| 9 | `src/features/cotizacion/services/__tests__/informativa.test.ts` | 10 | 20 | 0 | 0 | 10 | 0 | 0 |
| 10 | `src/features/cotizacion/services/__tests__/wizard.test.ts` | 10 | 20 | 0 | 0 | 10 | 0 | 0 |
| 11 | `src/features/portal/services/__tests__/queries.test.ts` | 11 | 20 | 1 | 0 | 10 | 0 | 0 |
| 12 | `src/lib/mappers/genericPayloadMapper.ts` | 11 | 19 | 1 | 1 | 9 | 0 | 0 |
| 13 | `src/features/cotizacion/hooks/__tests__/usePaso1SectionStatus.test.tsx` | 9 | 18 | 0 | 0 | 9 | 0 | 0 |
| 14 | `src/features/cotizacion/hooks/wizard/__tests__/useCotizacionWizardSteps.test.tsx` | 9 | 18 | 0 | 0 | 9 | 0 | 0 |
| 15 | `src/features/cotizacion/services/revalidacion/index.ts` | 11 | 18 | 0 | 4 | 7 | 0 | 0 |
