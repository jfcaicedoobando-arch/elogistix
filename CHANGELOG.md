...
- **chore(cotizaciones)**: correctivo de CI (guard Power of 10) — `SeccionCostosInternosPLDetalle.tsx` rebasaba las 200 líneas tras el gate de edición por estado.
  - El gate y el aviso (`useGateEdicionCostos` + `AvisoCostosBloqueados`) se extraen al módulo focalizado `edicionCostosGate.tsx`; comportamiento idéntico, sin cambios en allowlist ni lógica.
  - El archivo queda en 195 líneas.
