...
BEGIN
  ...
  -- Las facturas nacen en 'Borrador': el guard B-18
  -- (conceptos_factura_assert_borrador) sólo admite conceptos mientras la
  -- factura no está emitida, igual que en la app.
  -- =========================================================================
  RESET ROLE; PERFORM set_config('request.jwt.claims', NULL, true);
  INSERT INTO public.facturas(
    ...
    (fac_a, org_a, cli_a, 'Cli OPS A', emb_a, 'F-OPS-A', CURRENT_DATE, CURRENT_DATE+30, 'MXN', 1000, 160, 1160, 'Borrador'),
    (fac_b, org_b, cli_b, 'Cli OPS B', emb_b, 'F-OPS-B', CURRENT_DATE, CURRENT_DATE+30, 'MXN', 5000, 800, 5800, 'Borrador');
