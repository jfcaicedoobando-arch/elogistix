...
BEGIN
  ...
  INSERT INTO public.cotizacion_costos(cotizacion_id, concepto, moneda, cantidad, costo_unitario, costo_total)
  VALUES (cot_a, 'Flete', 'USD', 3, 1000, 3000);

  INSERT INTO public.embarque_contenedores(id, embarque_id, numero, tipo, organization_id) VALUES
