-- =============================================================
-- crm_vincular_moneda_vendedor.sql
--
...
BEGIN
  ...
  INSERT INTO public.cotizaciones (id, organization_id, folio, modo, tipo, es_prospecto, moneda) VALUES
    (v_cot1, v_org, 'TEST-MV-1', 'Marítimo', 'Importación', true, 'USD'::moneda),
    (v_cot2, v_org, 'TEST-MV-2', 'Marítimo', 'Importación', true, 'EUR'::moneda),
    (v_cot3, v_org, 'TEST-MV-3', 'Marítimo', 'Importación', true, 'USD'::moneda);
  ...
  PERFORM pg_temp.assert(v_op_mon = 'USD',
    format('CASO 1: se esperaba moneda USD heredada de la cotización y llegó %', v_op_mon));
  ...
  PERFORM pg_temp.assert(v_op_mon = 'EUR',
    format('CASO 3: se esperaba moneda EUR heredada de la cotización y llegó %', v_op_mon));
