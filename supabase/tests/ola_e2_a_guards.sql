...
BEGIN
  ...
  IF v_pol IS NULL OR v_pol NOT LIKE '%puede_ver_costos_cotizacion%' THEN
    RAISE EXCEPTION 'C9 REGRESIÓN: la policy de lectura de cotizacion_costos no usa el helper de costos';
  END IF;
END $$;
