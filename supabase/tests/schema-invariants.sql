...
DECLARE
  expected_triggers text[] := ARRAY[
    ...
    'pagos_proveedor|tg_pagos_proveedor_no_sobrepago',
    'pagos_proveedor|trg_pago_proveedor_factura_viva',
    'pagos_proveedor|trg_pagos_proveedor_monto_convertido',
  ...
  expected_functions text[] := ARRAY[
    ...
    'tg_pago_proveedor_no_sobrepago',
    'tg_pagos_factura_monto_convertido',
    'tg_pagos_proveedor_monto_convertido',
