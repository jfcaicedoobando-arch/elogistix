-- Espejo de replay: re-emite el fix de 20260823211159 con timestamp POSTERIOR
-- a 20260828000100 (que re-emite las mismas dos funciones) para que un replay
-- en base limpia no reintroduzca la notificación huérfana ni el guard sin rol.
-- ============================================================================
