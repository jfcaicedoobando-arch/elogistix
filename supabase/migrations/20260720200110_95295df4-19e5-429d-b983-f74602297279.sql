...
BEGIN
  ...
  -- v13.302.12 (Sentry JAVASCRIPT-REACT-2Y): la columna real en `pagos_proveedor`
  -- es `proveedor_factura_id`, no `factura_id`. El JOIN previo hacía que la RPC
  -- fallara con `column pp.factura_id does not exist` y rompía el Tab Cierre.
