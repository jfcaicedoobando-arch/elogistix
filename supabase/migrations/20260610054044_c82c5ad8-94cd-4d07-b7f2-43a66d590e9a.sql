...
BEGIN
  ...
  VALUES
    ...
    (v_org, v_emb2, (CURRENT_DATE - 2)::timestamptz, 'Arribo a Puerto'::tipo_evento_tracking, 'Arribo a Lázaro Cárdenas', 'MXLZC', 'sistema@demo'),
    (v_org, v_emb4, (CURRENT_DATE - 45)::timestamptz, 'Zarpe'::tipo_evento_tracking, 'Salida de Qingdao', 'CNTAO', 'sistema@demo'),
    (v_org, v_emb4, (CURRENT_DATE - 18)::timestamptz, 'Arribo a Puerto'::tipo_evento_tracking, 'Arribo a Manzanillo', 'MXZLO', 'sistema@demo'),
    (v_org, v_emb4, (CURRENT_DATE - 16)::timestamptz, 'Entrega'::tipo_evento_tracking, 'Entrega final al cliente', 'Manzanillo', 'sistema@demo');
