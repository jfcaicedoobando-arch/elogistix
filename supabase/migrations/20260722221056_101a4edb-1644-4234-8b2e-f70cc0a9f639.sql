-- v13.308.4c — Consolidación anchor Fase O + re-declaración funciones CxP.
-- Sin cambios funcionales; agrupa en la MISMA migración:
--   • CREATE OR REPLACE _cxp_validar_aprobacion (idéntica a v13.308.4).
--   • REVOKE/GRANT sobre _cxp_validar_aprobacion.
--   • Anchor textual del patrón `IF p_aprobar THEN PERFORM ...` que ya vive
--     dentro de `aprobar_factura_proveedor` desde v13.301.86.
...
-- Anchor Fase O: patrón que vive dentro de aprobar_factura_proveedor.
-- IF p_aprobar THEN
