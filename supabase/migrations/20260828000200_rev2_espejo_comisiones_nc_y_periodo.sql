-- Espejo de replay (informe 2026-08-22 · Entrega 2): re-emite los fixes de
-- 20260822002739 después de 20260826003000_ola2_comisiones_espejo.sql,
-- que es quien reintroducía la comisión sin puente factura_embarques (B-2)
-- y sin la zona America/Mexico_City (B-5).
-- ============================================================
-- Ola de remediación (informe 2026-08-22) · Entrega 2
-- B-2 · Re-emisión definitiva de calcular_comision_pago(uuid) DESPUÉS del
--       espejo 20260826003000 (que la redefinía sin el puente
--       factura_embarques -> comisión 0 en facturas consolidadas).
-- B-4 · La nota de crédito ahora también acota el numerador del prorrateo.
-- B-5 · Re-emisión de generar_liquidacion_comision con el periodo en
--       zona America/Mexico_City (se perdía en un replay limpio).
-- ============================================================
