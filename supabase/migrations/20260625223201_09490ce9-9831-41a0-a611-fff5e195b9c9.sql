...
BEGIN
  ...
  -- 1) Operación: datos de contenedores (peso/volumen) — solo FCL marítimo
  ...
  -- v13.135.70 — Ampliado a CUALQUIER embarque con al menos 1 contenedor cargado
  -- (antes sólo FCL marítimo). Si el embarque no tiene contenedores la regla
  -- se omite del checklist (no aplica).
  SELECT EXISTS (
