-- v13.823.54b — La puerta de sesión sólo aplica a los roles de la API
-- (anon/authenticated). Procesos internos (service_role, mantenimiento) siguen
-- operando sin claims, como antes de esta ola.
