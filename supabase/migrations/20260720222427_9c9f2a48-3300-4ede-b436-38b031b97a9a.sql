...
BEGIN
  ...
  -- Extraer código entre paréntesis "Ciudad, País (ABCDE)" → "ABCDE".
  -- Fallback: guardar el texto completo si no hay paréntesis.
...
-- Backfill del embarque E-ELIMP00333 (generado desde COT-2026-0138) con los
-- datos que la RPC previa no copiaba.
