-- Restaurar validar_cierre_embarque con cuerpo legacy + check REP integrado
DROP FUNCTION IF EXISTS public._validar_cierre_embarque_base(uuid);
...
BEGIN
  ...
  -- 7) Fiscal: REPs pendientes (Complemento de Pagos sin timbrar)
