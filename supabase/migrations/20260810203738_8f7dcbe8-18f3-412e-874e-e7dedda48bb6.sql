-- Ola 4 · N44-fix: reaplica N44 conservando la firma vigente de
--   cartera_pendiente. La migración 20260812090000 abortó (en base limpia y en
--   producción) porque cambiaba los nombres de las columnas de salida con
...
LANGUAGE sql STABLE SET search_path TO 'public' AS $function$
  ...
  WHERE (b.total - b.pagado - b.nc_aplicadas) > 0.005
    AND (public.org_scope() IS NULL OR c.organization_id = public.org_scope() OR c.organization_id IS NULL)
