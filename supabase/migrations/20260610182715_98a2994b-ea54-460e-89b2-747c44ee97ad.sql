    ...
    WHERE ur.user_id = _user_id
      AND ur.role = ANY (
        CASE _role
          ...
          WHEN 'viewer'::app_role THEN ARRAY['viewer','customer_service','vendedor','contador','tesorero','ejecutivo_pricing','gerente_operaciones','gerente_visor','coordinador_logistico','admin','admin_org','super_admin']::app_role[]
