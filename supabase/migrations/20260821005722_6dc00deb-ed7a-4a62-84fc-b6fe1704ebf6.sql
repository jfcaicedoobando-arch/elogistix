-- Ola 1 · re-emisión 1:1 de los espejos canónicos
-- (supabase/schema/facturacion/registrar_pago_cliente_lote.sql y
--  supabase/schema/cxp/registrar_pago_proveedor_lote.sql).
-- Motivo: BUG-15 y BL-03 re-emitieron ambas RPC desde una fuente anterior a la
-- Ola 1 y deshicieron, en replay limpio, el uso de
-- nc_aplicadas_en_moneda_factura y los locks deterministas.
