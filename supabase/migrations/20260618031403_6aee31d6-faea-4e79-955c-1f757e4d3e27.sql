...
BEGIN
  ...
  -- Contenedores FCL con datos completos (13.66.10)
  ...
  -- =========================================================
  -- v13.66.12 — Nuevas reglas: ventas y costos formalizados
  -- =========================================================

  -- 1) Conceptos de venta facturados (ninguno en 'pendiente' ni 'en_proforma')
  SELECT
  ...
  -- 2) Costos con factura de proveedor recibida
  ...
  -- 3) Costos liquidados (estado_liquidacion <> 'Pendiente')
