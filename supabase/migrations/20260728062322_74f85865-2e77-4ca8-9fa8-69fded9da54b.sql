-- ============================================================
-- FIX B-032 (E2E live 2026-07-28) · seed_demo_organization con CxP
-- Reemplaza íntegramente la definición de 20260610054044.
-- Agrega: limpieza CxP de la org demo + 3 facturas proveedor
-- (vencida / vigente / parcialmente pagada con pago parcial),
-- aprobadas y con conceptos que cuadran contra el subtotal.
-- ============================================================
