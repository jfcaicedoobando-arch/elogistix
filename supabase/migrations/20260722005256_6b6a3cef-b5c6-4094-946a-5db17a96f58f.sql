-- Fase D (re-aplicada v13.305.3) — saldo_factura con tenant guard + NCs completas
-- Corrige regresión introducida por BLOQUE 2 que dejó el test de Fase D en rojo.
...
BEGIN
  ...
  RAISE NOTICE 'Fase D backfill v13.305.3: % facturas re-marcadas como Pagada por NCs', v_actualizadas;
END;
$backfill$;