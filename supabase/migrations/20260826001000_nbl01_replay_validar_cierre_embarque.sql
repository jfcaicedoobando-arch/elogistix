-- N-BL-01 (v13.666.2) · Replay-safe: re-emisión del cuerpo vigente de
-- public.validar_cierre_embarque. La migración 20260826000200 (BUG-13) tiene
-- timestamp POSTERIOR a 20260818214910 (N-BL-01) y en replay limpio pisaba la
-- conversión de pagos CxP a la moneda de la factura. Cuerpo idéntico al espejo
-- supabase/schema/embarques/validar_cierre_embarque.sql (no cambia la BD real).
