-- Fix Sentry JAVASCRIPT-REACT-31 / JAVASCRIPT-REACT-1M:
-- convertir_proformas_a_factura llamaba a public.idempotency_commit(uuid, jsonb),
-- función que no existe. La firma correcta es public.idempotency_store(uuid, jsonb).
-- Reemplazamos únicamente esa línea; resto del cuerpo intacto.
