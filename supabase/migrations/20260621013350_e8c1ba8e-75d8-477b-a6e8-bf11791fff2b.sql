...
BEGIN
  ...
  -- v13.90.7 — Un concepto se considera facturado si su proforma vinculada está 'facturada'.
  -- Alinea esta regla con la lógica derivada del tab Facturación (estadoConceptoBadge).
  SELECT
    COUNT(*) FILTER (
