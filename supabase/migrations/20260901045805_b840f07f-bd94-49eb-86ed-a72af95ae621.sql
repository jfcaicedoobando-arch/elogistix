-- Reemisión idempotente del cuerpo canónico de validar_cierre_embarque
-- (replay-mirror: la migración 20260908000200 quedó con timestamp posterior al
-- fix LCL v13.820.6 y rompía el orden de replay; la base ya tiene este cuerpo).
