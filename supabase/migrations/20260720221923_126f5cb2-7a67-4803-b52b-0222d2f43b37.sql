...
BEGIN
  ...
  IF v_cotizacion_id IS NOT NULL THEN
    ...
    IF v_remaining = 0 THEN
      -- v13.303.14: revertir estado + limpiar vínculos bidireccionales.
      -- El soft-delete no dispara ON DELETE SET NULL de la FK, así que la
      -- cotización quedaba "atrapada" apuntando al embarque fantasma.
