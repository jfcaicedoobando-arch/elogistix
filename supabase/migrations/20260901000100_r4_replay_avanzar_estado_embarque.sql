-- R4BD-01: re-emisión del espejo de public.avanzar_estado_embarque.
-- La respuesta cacheada por idempotencia se devuelve marcada con `replay: true`
-- para que el frontend no duplique el registro de bitácora. No cambia tablas
-- ni permisos.
