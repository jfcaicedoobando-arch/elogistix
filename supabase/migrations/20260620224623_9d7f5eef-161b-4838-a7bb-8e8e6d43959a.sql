...
BEGIN
  ...
  -- Documentos completos (regla simplificada: todo documento cargado debe tener archivo)
  ...
  -- Contenedores FCL con datos completos
  ...
  -- Costos con factura de proveedor recibida
