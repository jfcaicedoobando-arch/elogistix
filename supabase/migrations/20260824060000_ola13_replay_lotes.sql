-- ============================================================
-- Ola 13 · Sprint 06 · R4BD-01: en replay limpio, la migración Ola 11
-- 20260821030800_ola11_lotes_paridad.sql (timestamp POSTERIOR a toda la
-- Ola 12) redefine registrar_pago_proveedor_lote SIN los guards
-- LC_LOTE_TC_REQUERIDO (R3BD-02) y LC_LOTE_FACTURA_MONEDA (R3BD-03),
-- anulando los fixes de integridad multi-moneda. En vivo la BD está bien;
-- el defecto sólo aparece al reconstruir (db reset / staging / CI).
-- Esta migración re-emite el cuerpo FINAL (idéntico a la Ola 12 S09,
-- 20260813185523_…) con timestamp posterior a 20260821030800 para que gane
-- en cualquier replay. Cuerpo VERBATIM del espejo
-- supabase/schema/cxp/registrar_pago_proveedor_lote.sql (1:1, sin tocar).
