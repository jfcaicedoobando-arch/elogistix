...
BEGIN
  ...
  -- v13.300.53 — Copiar renglones vivos de la factura original al borrador
  -- de sustitución, para que el editor los muestre precargados y el usuario
  -- sólo tenga que corregir lo necesario en lugar de recapturar todo.
