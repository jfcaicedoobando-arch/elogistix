-- N10 (v13.823.390): public.cartera_pendiente() termina en LIMIT 500 y la UI
-- paginaba ese arreglo como si fuera el total. Este contador (mismo predicado
-- de saldo, sin LIMIT) permite mostrar un aviso explícito de truncamiento.
-- Corre bajo RLS nativo (STABLE, SECURITY INVOKER): sólo cuenta lo que el
-- usuario puede leer.
