-- =====================================================================
-- Ola 6 · RG5-1: fail-closed de organización en
-- regenerar_movimiento_pago_proveedor. Antes: `IF v_org IS NOT NULL AND
-- v_pago.organization_id IS DISTINCT FROM v_org` — con org_scope() NULL
-- (super admin sin org activa, sesión sin membresía) el chequeo cross-org
-- se SALTABA por completo. Ahora sin organización resuelta se aborta.
-- =====================================================================
