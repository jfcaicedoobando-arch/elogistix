-- ============================================================
-- BL-18 (v13.640.2) — re-emisión del espejo canónico de
-- public.registrar_pago_cliente_lote: la migración vigente
-- 20260821030800_ola11_lotes_paridad.sql perdió el orden determinista
-- de locks (BL-13, 20260817143000) al recrear la función, así que en un
-- replay limpio volvía el deadlock entre lotes concurrentes. Esta
-- migración vuelve a aplicar el cuerpo del espejo (fuente canónica).
