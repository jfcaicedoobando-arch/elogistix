-- Auditoría 2026-08-28 · Hallazgo 2 (corrección): se elimina la columna
-- auxiliar sobrante del bloque de sobrecosto por concepto y se cierra el
-- acceso directo a este helper interno (sólo lo usa el flujo de aprobación,
-- que es SECURITY DEFINER y corre como dueño).
