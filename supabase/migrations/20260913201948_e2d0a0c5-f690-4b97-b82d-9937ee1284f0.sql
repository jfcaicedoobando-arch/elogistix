-- v13.823.346 — recotizar_cotizacion: candados de estado, motivo y concurrencia.
--
-- Antes sólo validaba pertenencia, motivo no vacío y ausencia de embarque, así
-- que una cotización en Borrador/Enviada/Rechazada podía "re-cotizarse" (y
-- perdía su estado) y dos llamadas simultáneas calculaban la misma versión.
