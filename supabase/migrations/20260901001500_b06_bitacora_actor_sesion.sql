-- B-06 (v13.749.0): el actor de la bitácora se deriva de la sesión autenticada.
-- El parámetro p_usuario_email se conserva por compatibilidad de firma, pero se IGNORA.
