-- FIX-H6-21 (Ola D): re-aplica el bloque canónico REVOKE/GRANT sobre las
-- funciones SECURITY DEFINER re-emitidas por las migraciones de la Ola D
-- (BUG-10, BUG-13, BUG-15, BUG-17), que omitieron el bloque en su archivo.
-- Los archivos originales quedan como legacy auditado (baseline bump).
