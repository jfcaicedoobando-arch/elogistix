-- ============================================================
-- Ola 13 · Sprint 06 · R4BD-03: en replay limpio, la migración Ola 6
-- 20260819090000_ola6_rg51_regenerar_movimiento_fail_closed.sql (timestamp
-- POSTERIOR al fix RBD-07, 20260813025053_…) redefine
-- regenerar_movimiento_pago_proveedor SIN el guard LC_PAGO_TC_REQUERIDO:
-- la rama cross-moneda registra el monto tal cual (1:1 silencioso, clase
-- BL-04) en vez de abortar. En vivo la BD está bien; el defecto sólo
-- aparece al reconstruir. Esta migración re-emite el cuerpo canónico
-- (idéntico a 20260813025053_…) con timestamp posterior a 20260819090000.
-- Cuerpo VERBATIM del espejo
-- supabase/schema/cxp/regenerar_movimiento_pago_proveedor.sql (1:1).
