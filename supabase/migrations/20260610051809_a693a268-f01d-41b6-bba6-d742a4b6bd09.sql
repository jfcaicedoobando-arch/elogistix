...
ON CONFLICT (id) DO UPDATE SET nombre = EXCLUDED.nombre, plan = EXCLUDED.plan, activo = true;
...
AS $$
  SELECT EXISTS (
    ...
    WHERE user_id = _user_id
      AND organization_id = 'de100000-0000-0000-0000-000000000001'::uuid
  )
$$;
...
BEGIN
  ...
  VALUES (_user_id, 'operador'::app_role)
  ON CONFLICT (user_id, role) DO NOTHING;

  INSERT INTO public.organization_members (user_id, organization_id, role)
  VALUES (_user_id, 'de100000-0000-0000-0000-000000000001'::uuid, 'operador'::app_role)
  ON CONFLICT (organization_id, user_id) DO UPDATE SET role = 'operador'::app_role;
END;
$$;
...
BEGIN
  ...
  VALUES (v_org, 'Agente Aduanal Pacífico', 'AgenteAduanal'::tipo_proveedor, 'México', 'AAP890101XX1', 'Lic. Pérez', 'gerencia@aapacifico.mx', '+52 314 222 1010', 'MXN'::moneda, 'Logistico'::categoria_proveedor);
  INSERT INTO public.proveedores (organization_id, nombre, tipo, pais, rfc, contacto, email, telefono, moneda_preferida, categoria)
  VALUES (v_org, 'Transportes Terrestres del Norte', 'TransporteTerrestre'::tipo_proveedor, 'México', 'TTN010101AA2', 'Op. de tráfico', 'trafico@ttnorte.mx', '+52 81 1234 5678', 'MXN'::moneda, 'Logistico'::categoria_proveedor);
  INSERT INTO public.proveedores (organization_id, nombre, tipo, pais, rfc, contacto, email, telefono, moneda_preferida, categoria)
  VALUES (v_org, 'Ocean Forwarders China Ltd.', 'AgenteCarga'::tipo_proveedor, 'China', '', 'Lily Chen', 'lily@oceanfwd.cn', '+86 21 5500 9090', 'USD'::moneda, 'Logistico'::categoria_proveedor);
  ...
  INSERT INTO public.embarques (
    ...
    'Maritimo'::modo_transporte, 'Importacion'::tipo_operacion,
    'Shenzhen Electronics Co.', 'Importadora del Pacífico S.A. de C.V.',
    'Electrónica de consumo', 18500, 58.4, 1200, 'FOB'::incoterm, 'En Transito'::estado_embarque, 'Demo Operador',
  ...
  INSERT INTO public.embarques (
    ...
    'Telas sintéticas en rollos', 22000, 65.0, 850, 'CIF'::incoterm, 'En Puerto'::estado_embarque, 'Demo Operador',
  ...
  INSERT INTO public.embarques (
    ...
    'Aereo'::modo_transporte, 'Importacion'::tipo_operacion,
  ...
  INSERT INTO public.cotizaciones (
    ...
    (v_org, 'COT-DEMO-001', v_cli3, 'Auto Partes Bajío S. de R.L.',
     'Maritimo'::modo_transporte, 'Importacion'::tipo_operacion, 'FOB'::incoterm,
    ...
    (v_org, 'COT-DEMO-002', v_cli2, 'Textiles Monterrey S.A.',
     'Aereo'::modo_transporte, 'Exportacion'::tipo_operacion, 'EXW'::incoterm,
