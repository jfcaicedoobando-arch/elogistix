-- ============================================================
-- Ola 5 · RG4-5 + RG4-6: validaciones del cobro en lote CxC.
-- RG4-5: el "importe recibido" del diálogo nunca llegaba a la RPC; el
--   sobrante se perdía sin anticipo ni saldo a favor. Ahora el reparto
--   debe ser EXACTAMENTE igual al importe recibido (tolerancia 0.01).
-- RG4-6: dos renglones con la misma factura_id sobre-aplicaban el pago.
