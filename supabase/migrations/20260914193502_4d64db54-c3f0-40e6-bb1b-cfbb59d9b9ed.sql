...
REVOKE ALL ON FUNCTION public.eliminar_embarque_completo(uuid) FROM anon;
GRANT EXECUTE ON FUNCTION public.eliminar_embarque_completo(uuid) TO authenticated;
GRANT EXECUTE ON FUNCTION public.eliminar_embarque_completo(uuid) TO service_role;
GRANT EXECUTE ON FUNCTION public.eliminar_embarque_completo(uuid) TO postgres;