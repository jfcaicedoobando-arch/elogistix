...
RETURNS TABLE(id uuid, nombre text, tipo tipo_proveedor, rfc text, contacto text, moneda_preferida moneda, pais text, origen_proveedor text, total_operaciones bigint, monto_pendiente numeric, total_count bigint)
LANGUAGE sql
STABLE
