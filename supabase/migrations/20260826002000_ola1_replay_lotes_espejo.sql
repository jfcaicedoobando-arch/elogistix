-- Ola 1 · re-emisión 1:1 de los espejos canónicos de las RPC de lote
-- (supabase/schema/facturacion/registrar_pago_cliente_lote.sql y
--  supabase/schema/cxp/registrar_pago_proveedor_lote.sql).
-- Motivo: BUG-15 y BL-03 re-emitieron ambas funciones desde una fuente previa
-- a la Ola 1 y, en replay limpio, deshacían nc_aplicadas_en_moneda_factura y
-- los locks deterministas (FOR UPDATE ordenado por factura_id).
