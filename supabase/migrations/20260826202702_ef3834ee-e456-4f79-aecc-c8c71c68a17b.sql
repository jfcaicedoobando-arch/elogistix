-- ============================================================================
-- QA ronda 2 · N-07 (2/2)
-- Al eliminar el pago / cancelar o sustituir la factura / excluir el embarque
-- de comision, las comisiones 'Liquidada' cuyo respaldo desaparece ya no
-- quedan mudas: se marcan con el estado 'Por recuperar' para su ajuste en la
-- siguiente liquidacion. Ademas v_comision_mxn se acota con GREATEST(0, ...).
-- ============================================================================
...
REVOKE ALL ON FUNCTION public.tg_factura_cancelada_comisiones() FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.tg_factura_cancelada_comisiones() TO authenticated, service_role;