-- Espejo de replay (Ola 8): re-emite los cuerpos vigentes con timestamp
-- posterior a 20260826002000_ola1_replay_lotes_espejo.sql para que una base
-- limpia termine con la autorización por organización (has_any_role_in_org).
