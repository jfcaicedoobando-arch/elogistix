-- v13.820.7 · Restaura el cuerpo real de dashboard_summary_datos().
-- La BD había quedado con un wrapper que lanzaba LC_DASHBOARD_SIN_PERMISO y
-- bloqueaba todo el tablero para roles operativos. El enmascarado de costos ya
-- lo hace la RPC pública dashboard_summary() (ver dashboard_rpc_costos.sql).
-- También alinea v_hoy a America/Mexico_City igual que dashboard_details_datos.
