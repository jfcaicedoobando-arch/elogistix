-- Fuente canónica de public.auditar_consistencia_cobranza (Ola v17).
-- Candado diario (cron `auditar_consistencia_cobranza_diario`, 06:35 MX):
-- sólo AVISA en alertas_sistema, nunca corrige datos.
--  1) facturas cuyo estado no coincide con su saldo canónico;
--  2) cobros vigentes con cuenta bancaria pero sin movimiento en el banco.
