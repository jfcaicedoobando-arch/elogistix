 ...
 * leen al timbrar el REP. Las Edge Functions usan la service role key
 * (bypassan RLS), así que el filtro explícito `.is("deleted_at", null)` es la
 * única defensa. Este test estructural falla si alguien lo quita de cualquiera
 * de esos flujos.
 */
